...
func (ChatMessage_Role) EnumDescriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{36, 0}
}
...
type ListRecipesResponse struct {
	...
	Recommendations []*RecipeSnippet `protobuf:"bytes,3,rep,name=recommendations,proto3" json:"recommendations,omitempty"`
	// The pagination token for the next page of recipes.
	Pagination    *Pagination `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListRecipesResponse) GetRecommendations() []*RecipeSnippet {
	if x != nil {
...
func (x *ChatPlanRequest) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (*GetChatMessagesResponse) Descriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{40}
}
...
func (x *GetUserRequest) Reset() {
	*x = GetUserRequest{}
	mi := &file_frontendapi_frontend_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{41}
}
...
func (x *GetUserResponse) Reset() {
	*x = GetUserResponse{}
	mi := &file_frontendapi_frontend_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserResponse) Descriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{42}
}

func (x *GetUserResponse) GetPlanPrompt() string {
	if x != nil {
		return x.PlanPrompt
	}
	return ""
...
type EditUserRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The prompt to use for the user's plan generation.
	PlanPrompt    *string `protobuf:"bytes,1,opt,name=plan_prompt,json=planPrompt,proto3,oneof" json:"plan_prompt,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EditUserRequest) Reset() {
	*x = EditUserRequest{}
	mi := &file_frontendapi_frontend_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EditUserRequest) Descriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{43}
}

func (x *EditUserRequest) GetPlanPrompt() string {
	if x != nil && x.PlanPrompt != nil {
		return *x.PlanPrompt
	}
	return ""
}
...
func (x *EditUserResponse) Reset() {
	*x = EditUserResponse{}
	mi := &file_frontendapi_frontend_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EditUserResponse) Descriptor() ([]byte, []int) {
	return file_frontendapi_frontend_proto_rawDescGZIP(), []int{44}
}
...
func (x *AddRecipeRequest_AddRecipeStep) Reset() {
	*x = AddRecipeRequest_AddRecipeStep{}
	mi := &file_frontendapi_frontend_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_frontendapi_frontend_proto_rawDesc = "" +
	...
	"\arecipes\x18\x01 \x03(\v2\x1a.frontendapi.RecipeSnippetR\arecipes\x12D\n" +
	"\x0frecommendations\x18\x03 \x03(\v2\x1a.frontendapi.RecipeSnippetR\x0frecommendations\x127\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x17.frontendapi.PaginationR\n" +
	"pagination\"\xef\x02\n" +
	...
	"\x04plan\x18\x01 \x01(\v2\x11.frontendapi.PlanB\x06\xbaH\x03\xc8\x01\x01R\x04plan\",\n" +
	"\x11DeletePlanRequest\x12\x17\n" +
	"\aplan_id\x18\x01 \x01(\tR\x06planId\"\x14\n" +
	"\x12DeletePlanResponse\"1\n" +
	...
	"\n" +
	"start_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\"z\n" +
	...
	"\achat_id\x18\x01 \x01(\tR\x06chatId\x124\n" +
	"\bmessages\x18\x02 \x03(\v2\x18.frontendapi.ChatMessageR\bmessages\x12\x17\n" +
	"\aplan_id\x18\x03 \x01(\tR\x06planId\"\x10\n" +
	"\x0eGetUserRequest\"2\n" +
	"\x0fGetUserResponse\x12\x1f\n" +
	"\vplan_prompt\x18\x01 \x01(\tR\n" +
	"planPrompt\"G\n" +
	"\x0fEditUserRequest\x12$\n" +
	"\vplan_prompt\x18\x01 \x01(\tH\x00R\n" +
	"planPrompt\x88\x01\x01B\x0e\n" +
	"\f_plan_prompt\"\x12\n" +
	"\x10EditUserResponse*Q\n" +
	"\bLanguage\x12\x18\n" +
	...
	"\vChatService\x12?\n" +
	"\x04Chat\x12\x18.frontendapi.ChatRequest\x1a\x19.frontendapi.ChatResponse(\x010\x012\x87\n" +
	"\n" +
	...
	"\n" +
	"UpdatePlan\x12\x1e.frontendapi.UpdatePlanRequest\x1a\x1f.frontendapi.UpdatePlanResponse\x12M\n" +
	"\n" +
	"DeletePlan\x12\x1e.frontendapi.DeletePlanRequest\x1a\x1f.frontendapi.DeletePlanResponse\x12P\n" +
	"\vAddBookmark\x12\x1f.frontendapi.AddBookmarkRequest\x1a .frontendapi.AddBookmarkResponse\x12Y\n" +
	"\x0eRemoveBookmark\x12\".frontendapi.RemoveBookmarkRequest\x1a#.frontendapi.RemoveBookmarkResponse\x12D\n" +
	"\aGetUser\x12\x1b.frontendapi.GetUserRequest\x1a\x1c.frontendapi.GetUserResponse\x12G\n" +
	"\bEditUser\x12\x1c.frontendapi.EditUserRequest\x1a\x1d.frontendapi.EditUserResponseB=Z;github.com/curioswitch/cookchat/frontend/api/go;frontendapib\x06proto3"
...
var file_frontendapi_frontend_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_frontendapi_frontend_proto_goTypes = []any{
	...
	(*DeletePlanRequest)(nil),              // 37: frontendapi.DeletePlanRequest
	(*DeletePlanResponse)(nil),             // 38: frontendapi.DeletePlanResponse
	(*AddBookmarkRequest)(nil),             // 39: frontendapi.AddBookmarkRequest
	(*AddBookmarkResponse)(nil),            // 40: frontendapi.AddBookmarkResponse
	(*RemoveBookmarkRequest)(nil),          // 41: frontendapi.RemoveBookmarkRequest
	(*RemoveBookmarkResponse)(nil),         // 42: frontendapi.RemoveBookmarkResponse
	(*ChatMessage)(nil),                    // 43: frontendapi.ChatMessage
	(*ChatPlanRequest)(nil),                // 44: frontendapi.ChatPlanRequest
	(*ChatPlanResponse)(nil),               // 45: frontendapi.ChatPlanResponse
	(*GetChatMessagesRequest)(nil),         // 46: frontendapi.GetChatMessagesRequest
	(*GetChatMessagesResponse)(nil),        // 47: frontendapi.GetChatMessagesResponse
	(*GetUserRequest)(nil),                 // 48: frontendapi.GetUserRequest
	(*GetUserResponse)(nil),                // 49: frontendapi.GetUserResponse
	(*EditUserRequest)(nil),                // 50: frontendapi.EditUserRequest
	(*EditUserResponse)(nil),               // 51: frontendapi.EditUserResponse
	(*AddRecipeRequest_AddRecipeStep)(nil), // 52: frontendapi.AddRecipeRequest.AddRecipeStep
...
var file_frontendapi_frontend_proto_depIdxs = []int32{
	...
	17, // 12: frontendapi.ListRecipesResponse.recommendations:type_name -> frontendapi.RecipeSnippet
	16, // 13: frontendapi.ListRecipesResponse.pagination:type_name -> frontendapi.Pagination
	...
	52, // 17: frontendapi.AddRecipeRequest.steps:type_name -> frontendapi.AddRecipeRequest.AddRecipeStep
	...
	53, // 22: frontendapi.PlanSnippet.date:type_name -> google.protobuf.Timestamp
	17, // 23: frontendapi.PlanSnippet.recipes:type_name -> frontendapi.RecipeSnippet
	53, // 24: frontendapi.GetPlansRequest.start_date:type_name -> google.protobuf.Timestamp
	29, // 25: frontendapi.GetPlansResponse.plans:type_name -> frontendapi.PlanSnippet
	4,  // 26: frontendapi.Plan.status:type_name -> frontendapi.PlanStatus
	17, // 27: frontendapi.Plan.recipes:type_name -> frontendapi.RecipeSnippet
	28, // 28: frontendapi.Plan.step_groups:type_name -> frontendapi.StepGroup
	12, // 29: frontendapi.Plan.ingredients:type_name -> frontendapi.IngredientSection
	32, // 30: frontendapi.GetPlanResponse.plan:type_name -> frontendapi.Plan
	32, // 31: frontendapi.UpdatePlanResponse.plan:type_name -> frontendapi.Plan
	6,  // 32: frontendapi.ChatMessage.role:type_name -> frontendapi.ChatMessage.Role
	53, // 33: frontendapi.ChatPlanRequest.start_time:type_name -> google.protobuf.Timestamp
	43, // 34: frontendapi.ChatPlanResponse.messages:type_name -> frontendapi.ChatMessage
	43, // 35: frontendapi.GetChatMessagesResponse.messages:type_name -> frontendapi.ChatMessage
	8,  // 36: frontendapi.ChatService.Chat:input_type -> frontendapi.ChatRequest
	14, // 37: frontendapi.FrontendService.GetRecipe:input_type -> frontendapi.GetRecipeRequest
	18, // 38: frontendapi.FrontendService.ListRecipes:input_type -> frontendapi.ListRecipesRequest
	20, // 39: frontendapi.FrontendService.StartChat:input_type -> frontendapi.StartChatRequest
	22, // 40: frontendapi.FrontendService.AddRecipe:input_type -> frontendapi.AddRecipeRequest
	24, // 41: frontendapi.FrontendService.GenerateRecipe:input_type -> frontendapi.GenerateRecipeRequest
	26, // 42: frontendapi.FrontendService.GeneratePlan:input_type -> frontendapi.GeneratePlanRequest
	44, // 43: frontendapi.FrontendService.ChatPlan:input_type -> frontendapi.ChatPlanRequest
	46, // 44: frontendapi.FrontendService.GetChatMessages:input_type -> frontendapi.GetChatMessagesRequest
	30, // 45: frontendapi.FrontendService.GetPlans:input_type -> frontendapi.GetPlansRequest
	33, // 46: frontendapi.FrontendService.GetPlan:input_type -> frontendapi.GetPlanRequest
	35, // 47: frontendapi.FrontendService.UpdatePlan:input_type -> frontendapi.UpdatePlanRequest
	37, // 48: frontendapi.FrontendService.DeletePlan:input_type -> frontendapi.DeletePlanRequest
	39, // 49: frontendapi.FrontendService.AddBookmark:input_type -> frontendapi.AddBookmarkRequest
	41, // 50: frontendapi.FrontendService.RemoveBookmark:input_type -> frontendapi.RemoveBookmarkRequest
	48, // 51: frontendapi.FrontendService.GetUser:input_type -> frontendapi.GetUserRequest
	50, // 52: frontendapi.FrontendService.EditUser:input_type -> frontendapi.EditUserRequest
	9,  // 53: frontendapi.ChatService.Chat:output_type -> frontendapi.ChatResponse
	15, // 54: frontendapi.FrontendService.GetRecipe:output_type -> frontendapi.GetRecipeResponse
	19, // 55: frontendapi.FrontendService.ListRecipes:output_type -> frontendapi.ListRecipesResponse
	21, // 56: frontendapi.FrontendService.StartChat:output_type -> frontendapi.StartChatResponse
	23, // 57: frontendapi.FrontendService.AddRecipe:output_type -> frontendapi.AddRecipeResponse
	25, // 58: frontendapi.FrontendService.GenerateRecipe:output_type -> frontendapi.GenerateRecipeResponse
	27, // 59: frontendapi.FrontendService.GeneratePlan:output_type -> frontendapi.GeneratePlanResponse
	45, // 60: frontendapi.FrontendService.ChatPlan:output_type -> frontendapi.ChatPlanResponse
	47, // 61: frontendapi.FrontendService.GetChatMessages:output_type -> frontendapi.GetChatMessagesResponse
	31, // 62: frontendapi.FrontendService.GetPlans:output_type -> frontendapi.GetPlansResponse
	34, // 63: frontendapi.FrontendService.GetPlan:output_type -> frontendapi.GetPlanResponse
	36, // 64: frontendapi.FrontendService.UpdatePlan:output_type -> frontendapi.UpdatePlanResponse
	38, // 65: frontendapi.FrontendService.DeletePlan:output_type -> frontendapi.DeletePlanResponse
	40, // 66: frontendapi.FrontendService.AddBookmark:output_type -> frontendapi.AddBookmarkResponse
	42, // 67: frontendapi.FrontendService.RemoveBookmark:output_type -> frontendapi.RemoveBookmarkResponse
	49, // 68: frontendapi.FrontendService.GetUser:output_type -> frontendapi.GetUserResponse
	51, // 69: frontendapi.FrontendService.EditUser:output_type -> frontendapi.EditUserResponse
...
func file_frontendapi_frontend_proto_init() {
	...
	file_frontendapi_frontend_proto_msgTypes[43].OneofWrappers = []any{}
	type x struct{}
