...
type RecipeContent struct {
	// The source URL of the recipe if externally sourced.
	// Since we parse AI responses into this struct, we go ahead and include it here
	// though save on the top-level recipe itself.
...
type Recipe struct {
	...
	// ContentGenerated indicates whether the recipe from the original source has had
	// its content regenerated by AI.
	ContentGenerated bool `firestore:"contentGenerated"`
...
var RecipeContentSchema = &genai.Schema{
	...
	Properties: map[string]*genai.Schema{
		...
		"sourceUrl": {
			Type:        "string",
			Description: "The source URL of the recipe if externally sourced.",
		},
		"description": {
			Type:        "string",
